...
gym.register(
    id="Isaac-Repose-Cube-Leap-Hand-v0",
...
gym.register(
    id="Isaac-Repose-Cube-Leap-Hand-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Isaac-Repose-Cube-Leap-Hand-NoVelObs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Isaac-Repose-Cube-Leap-Hand-NoVelObs-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
